...
Hablas directamente con ${userName || 'tu paciente'} para saber cómo se siente hoy con sus medicamentos: ${medSummary || 'sus remedios habituados'}.
Habla con frases cortas, naturales y humanas. Haz una sola pregunta a la vez. Pregúntale si sintió algún mareo, dolor u otra molestia.`;
  ...
  try {
    await vapi.start({
      ...
      voice: {
        provider: '11labs',
        voiceId: 'cgSgspJ2msU6clMCkdW9', // Friendly warm voice
      },
    });
  }
  catch (error) {
